...
var arr = [1, 3, 4, 5, 8, 9, 7]; // funcao map sever pra percorrer o vetor e retorna uma nova informação
...
console.log(newArr); //funcao reduce e uma forma de consumir todo vetor e transforma em uma unica informação geralmente uma
//variavel numero
...
console.log(filter); //função find verifica se existe alguma informação dentro do array ou encontrar essa informação
//dentro do array
